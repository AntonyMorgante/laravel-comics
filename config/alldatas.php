...
return [
    ...
    "footerlists" => [
        [["name" => "Dc comics"],["name" => "Lorem Ipsum"],["name" => "Lorem Ipsum"],["name" => "Lorem Ipsum"],["name" => "Lorem Ipsum"],["name" => "Lorem Ipsum"],["name" => "Lorem Ipsum"],["name" => "Lorem Ipsum"]],
        [["name" => "Shop"],["name" => "Lorem Ipsum"],["name" => "Lorem Ipsum"]],
        [["name" => "Dc"],["name" => "Lorem Ipsum"],["name" => "Lorem Ipsum"],["name" => "Lorem Ipsum"],["name" => "Lorem Ipsum"],["name" => "Lorem Ipsum"],["name" => "Lorem Ipsum"],["name" => "Lorem Ipsum"],["name" => "Lorem Ipsum"],["name" => "Lorem Ipsum"],["name" => "Lorem Ipsum"],["name" => "Lorem Ipsum"]],
        [["name" => "Sites"],["name" => "Lorem Ipsum"],["name" => "Lorem Ipsum"],["name" => "Lorem Ipsum"],["name" => "Lorem Ipsum"],["name" => "Lorem Ipsum"]]
    ],
    "socials" => [
    [
      "name"=> "Facebook",
